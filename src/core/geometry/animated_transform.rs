...
#![allow(dead_code)]
use super::{
    abs, bounds3, clamp, empty_bounds3, interval, lerp, max, translate, vector3, Bounds3, Bounds3f,
    Dot, Float, Matrix4x4, Point3f, Quaternion, Ray, Transform, Union, Vector3f,
};
...
impl AnimatedTransform {
    ...
    pub fn interpolate(&self, time: Float) -> Transform {
        ...
        translate(&trans) * Transform::from(rotate) * Transform::from(scale)
    }
    ...
    pub fn motion_bounds(&self, b: &Bounds3f) -> Bounds3f {
        ...
        (0..8u8).fold(empty_bounds3::<Float>(), |bounds, corner| {
