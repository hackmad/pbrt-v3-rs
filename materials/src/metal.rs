...
pub struct MetalMaterial {
    ...
    /// Absorption coefficient to use in computing the material's reflectance.
...
impl From<&TextureParams> for MetalMaterial {
    ...
    fn from(tp: &TextureParams) -> Self {
        let copper_n_samples = (0..COPPER_SAMPLES)
...
/// Number of samples for copper material.
const COPPER_SAMPLES: usize = 56;

#[rustfmt::skip]
const COPPER_WAVE_LENGTHS: [Float; COPPER_SAMPLES] = [
